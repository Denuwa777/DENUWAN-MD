...
console.log("Connecting YOUR BOT BOT 🤖...");
...
//=========OWNER - REACTION ===============================  
if(senderNumber.includes("94729039766")){
if(isReact) return
m.react("👨‍💻")
}
if(senderNumber.includes("947")){
if(isReact) return
m.react("😂")
}
